...
<body>
	...
	<div class="container mx-auto  bg-image mb-3 mt-2" style="overflow: scroll;">
		<h3 class="text-center fs-1 mt-2" style="font-style: italic;font-family: cursive;color: white;">Non-Veg Menu Items</h3>
		<div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 g-5  gx-3 py-5 px-2 mx-2">
			...
			for (MenuItem menuu : rmenu) {
				if(menuu.getType().toLowerCase().equals("nonveg"))
				{
			%>
			<div class="col">
